...
const outputFile = "public/videos/output.mp4";

let currentProgress = 0;

exports.editVideo = async function (inputFile) {
  try {
    ...
    console.log("path", pathPublic);

    if (!fs.existsSync("temp")) fs.mkdirSync("temp");
    console.log("temp", pathPublic);
